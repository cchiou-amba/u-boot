...
#ifdef CONFIG_BOARD_N1_V120
#  define SERIAL_NUM "serial#=Ambarella N1 v120\0"
#else
#  ifdef CONFIG_BOARD_N1_V110
#     define SERIAL_NUM "serial#=Ambarella N1 v110\0"
#   else
#     define SERIAL_NUM "serial#=Ambarella N1\0"
#  endif
#endif
