...
/* ==========================================================================*/
typedef struct amba_nand_sdr_timings {
	u32	timing0;
	u32	timing1;
	u32	timing2;
	u32	timing3;
	...
	u32	timing5;
	u32	timing6;
}amba_nand_sdr_timings_t;

typedef struct amba_nand_data_interface {
	union {
		amba_nand_sdr_timings_t sdr;
	} timings;
}amba_nand_data_interface_t;

static const amba_nand_data_interface_t amba_onfi_sdr_timings[] = {
	/* Mode 0 */
	{
		.timings.sdr = {
			.timing0=0x32324628,
